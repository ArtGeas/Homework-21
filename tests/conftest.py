...
def movie_dao():
    ...
    movie_1 = Movie(id=1, title='Movie 1', description='description 1', trailer='trailer 1',
                    year=2001, rating=10.0, genre_id=1, director_id=1)
    movie_2 = Movie(id=2, title='Movie 2', description='description 2', trailer='trailer 2',
                    year=2002, rating=10.0, genre_id=2, director_id=2)
    movie_3 = Movie(id=3, title='Movie 3', description='description 3', trailer='trailer 3',
                    year=2003, rating=10.0, genre_id=3, director_id=3)
